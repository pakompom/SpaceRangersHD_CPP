...
namespace fPlanetQuest {
    ...
    pas::WideString TfPlanetQuest::GetTextBeforeDelimiter(const pas::WideString& Text, char16_t Delimiter) {
        std::int32_t I{};
        pas::WideString S{};
        std::int32_t N = Text.length();
        for (auto cpp_range = pas::for_to<std::int32_t>(1, N); cpp_range.next(I); ) {
            if (Text.read(I) == Delimiter) {
                break;
            }
            S = pas::concat_wide({S, Text.read(I)});
        }
        return S;
    }
    ...
    void TfPlanetQuest::ClearChoices() {
        GI_PanelScrollBar::TPanelScrollBarGI* Panel = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()));
        ...
        ChoiceCount = 0;
        GI_Panel::TPanelGI* Spacer = pas::construct_call<GI_Panel::TPanelGI>(GI_Panel::TPanelGI_Create, GetByName(u"ActionListWindow"_wref.get()));
    ...
    void TfPlanetQuest::AddChoice(pas::WideString Text, std::int32_t Value, TQuestChoiceEvent Callback) {
        ...
        GI_PanelScrollBar::TPanelScrollBarGI* Owner = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()));
    ...
    void TfPlanetQuest::AddDisabledChoice(pas::WideString Text, std::int32_t Value, TQuestChoiceEvent Callback) {
        ...
        Text = EC_Str::RemoveMatchingTextTagsW(Text, u"color"_wref.get(), u"COLOR"_wref.get());
        Text = EC_Str::RemoveMatchingTextTagsW(Text, u"/color"_wref.get(), u"/COLOR"_wref.get());
        GI_PanelScrollBar::TPanelScrollBarGI* Owner = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()));
        GI_Panel::TPanelGI* Panel = pas::construct_call<GI_Panel::TPanelGI>(GI_Panel::TPanelGI_Create, Owner);
        Panel->SetName(pas::wide_int_to_str(ChoiceCount));
    ...
    void TfPlanetQuest::ProcessMouseWheel(std::uint32_t KeyState, WindowsSdk::TPoint Point, std::int32_t Delta) {
        ...
        if (Delta == WindowsSdk::WHEEL_DELTA) {
            if (GetByName(u"ActionListWindow"_wref.get())->ContainsPoint(Point)) {
                Panel1 = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()));
                ...
                Panel2 = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"MessageWindow"_wref.get()));
            ...
            if (GetByName(u"ActionListWindow"_wref.get())->ContainsPoint(Point)) {
                Panel3 = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()));
                ...
                Panel4 = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"MessageWindow"_wref.get()));
    ...
    void TfPlanetQuest::FinishChoiceLayout() {
        ...
        if (GlobalsV::QuestPageAnimationEnabled) {
            GetByName(u"ActionListWindow"_wref.get())->SetActive(false);
    ...
    void TfPlanetQuest::AnimateTextPage(GI_MessageLoop::PCallbackTimerGI Timer, std::int32_t UserData) {
        ...
        if (!Moving) {
            ...
            GetByName(u"ActionListWindow"_wref.get())->SetActive(true);
            GR_Main::PostMouseMoveMessage();
        }
    }

    void TfPlanetQuest::ClearParameterPanel() {
        GI_Panel::TPanelGI* Panel = pas::checked_cast<GI_Panel::TPanelGI*>(GetByName(u"ParamsShowWindow"_wref.get()));
        Panel->FreeOwnedChildren();
        ParameterPanelWidth = 0;
        ParameterPanelHeight = 0;
    }
    ...
    void TfPlanetQuest::AppendParameterText(pas::WideString Text) {
        ...
        Text = EC_Str::RemoveMatchingTextTagsW(Text, u"fix"_wref.get(), u"FIX"_wref.get());
        Text = EC_Str::RemoveMatchingTextTagsW(Text, u"/fix"_wref.get(), u"/FIX"_wref.get());
        Text = ([&] {
            const pas::WideString& textColorTag = GetTextColorTag(GlobalsV::QuestStyleIndex);
            const pas::WideString& text = Text;
            return EC_Str::ReplaceAllWideString(text, textColorTag, u"<color=255,240,100>"_wref.get());
        }());
    ...
    void TfPlanetQuest::LayoutParameterPanel() {
        GI_Window::TWindowGI* Window = pas::checked_cast<GI_Window::TWindowGI*>(GetByName(u"ParamsShowWindowParent"_wref.get()));
        GI_Panel::TPanelGI* Panel = pas::checked_cast<GI_Panel::TPanelGI*>(GetByName(u"ParamsShowWindow"_wref.get()));
    ...
    void TfPlanetQuest::InitializeLayout() {
        ...
        ViewportRect = ClassesImports::Rect(0, 0, GR_Main::GameScreenWidth, GR_Main::GameScreenHeight);
        {
            ...
            {
                GI_MessageLoop::TObjectGI* ImageFrame = MainPanel->FindByNameRecursive(u"ImageFrame"_wref.get());
            ...
            {
                GI_MessageLoop::TObjectGI* PQI = MainPanel->FindByNameRecursive(u"PQI"_wref.get());
                PQI->SetPosition(ClassesImports::Point(PQI->LocalPosition.X + GR_Main::ExtraScreenWidth, PQI->LocalPosition.Y));
            }
            {
                GI_MessageLoop::TObjectGI* AnimTextOn = MainPanel->FindByNameRecursive(u"AnimTextOn"_wref.get());
            ...
            {
                GI_MessageLoop::TObjectGI* AnimTextOff = MainPanel->FindByNameRecursive(u"AnimTextOff"_wref.get());
            ...
            for (auto cpp_range = pas::for_to<std::int32_t>(1, 4); cpp_range.next(I); ) {
                GI_MessageLoop::TObjectGI* cpp_with_6 = MainPanel->FindByNameRecursive(static_cast<pas::WideString>(pas::concat_ansi({"Style", SysUtils::IntToStr(I)})));
            ...
            {
                GI_MessageLoop::TObjectGI* ButtonExit = MainPanel->FindByNameRecursive(u"ButtonExit"_wref.get());
            ...
            Shift -= I;
            {
                GI_MessageLoop::TObjectGI* BGStyle = MainPanel->FindByNameRecursive(u"BGStyle"_wref.get());
            ...
            {
                GI_MessageLoop::TObjectGI* QuestPanel = MainPanel->FindByNameRecursive(u"QuestPanel"_wref.get());
                QuestPanel->SetSize(ClassesImports::Point(GR_Main::GameScreenWidth, GR_Main::GameScreenHeight));
                {
                    GI_PanelScrollBar::TPanelScrollBarGI* MessageWindow = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(QuestPanel->FindByNameRecursive(u"MessageWindow"_wref.get()));
                ...
                {
                    GI_PanelScrollBar::TPanelScrollBarGI* ActionListWindow = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(QuestPanel->FindByNameRecursive(u"ActionListWindow"_wref.get()));
            ...
            {
                GI_MessageLoop::TObjectGI* ParamsShowWindowParent = MainPanel->FindByNameRecursive(u"ParamsShowWindowParent"_wref.get());
        ...
        ParameterPanelOrigin = GetByName(u"ParamsShowWindowParent"_wref.get())->LocalPosition;
        SetHelpCallback(pas::bind_method<&TfPlanetQuest::ShowControlHelp>(this));
        {
            GI_GraphButton::TGraphButtonGI* AnimTextOn_2 = pas::checked_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(u"AnimTextOn"_wref.get()));
            AnimTextOn_2->UserValue = 0;
            AnimTextOn_2->UpCallback = pas::bind_method<&TfPlanetQuest::SelectPageMode>(this);
        }
        {
            GI_GraphButton::TGraphButtonGI* AnimTextOff_2 = pas::checked_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(u"AnimTextOff"_wref.get()));
        ...
        QuestStyleCount = I - 1;
        GetByName(u"MainPanel"_wref.get())->KeyDownCallback = pas::bind_method<&TfPlanetQuest::QuestKeyDown>(this);
        pas::checked_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(u"ButtonExit"_wref.get()))->UpCallback = pas::bind_method<&TfPlanetQuest::RequestLoadGame>(this);
    ...
    void TfPlanetQuest::OnOpen() {
        ...
        try {
            ...
            GetByName(u"PQI"_wref.get())->SetActive(false);
            CurrentPicture = pas::WideString();
            pas::checked_cast<GI_Panel::TPanelGI*>(GetByName(u"QuestPanel"_wref.get()))->SetActive(true);
            Stage = 3;
            ClearChoices();
            ...
            Stage = 4;
            if (pas::list_count(aScript::QueuedTextQuests) == 0 && aPlayer::GetPlayer() != nullptr && aPlayer::GetPlayer()->CurrentPlanet != nullptr && aPlayer::GetPlayer()->CurrentPlanet->TextQuestId >= 10000 && (GR_Main::LanguageDataConfig->GetBlock(u"PlanetQuest"_wref.get())->CountBlocks(u"PlanetQuestLic"_wref.get()) <= 0 || ([&] {
                pas::WideString cpp_string = ([&] {
                ...
                MoneyLimitComplement = aGalaxy::Galaxy->ComputeScaledBigMoney(2) + aPlayer::GetPlayer()->Money ^ 0xffffffffu;
            ...
            if (aPlayer::GetPlayer() != nullptr && aPlayer::GetPlayer()->CurrentPlanet != nullptr && aPlayer::GetPlayer()->InPrison) {
                ...
                Quest = pas::construct_call<TextQuest::TTextQuest>(TextQuest::TTextQuest_Create);
                if (EC_Str::IsIntegerTextW(ActiveQueuedTextQuest->Name)) {
                ...
                Stage = 19;
                Quest = pas::construct_call<TextQuest::TTextQuest>(TextQuest::TTextQuest_Create);
                if (EC_Str::IsIntegerTextW(GlobalsV::PendingQuestName)) {
            ...
            ApplyStyle();
            Stage = 24;
            reinterpret_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(pas::concat_wide({u"Style", EC_Str::IntToWideString(GlobalsV::QuestStyleIndex + 1)})))->ExecuteOnPressCode();
            Stage = 25;
            if (aGalaxy::Galaxy != nullptr) {
    ...
    pas::WideString TfPlanetQuest::GetTextColorTag(std::int32_t StyleIndex) {
        ...
        if (Block->CountBlocks(u"QTextColor"_wref.get()) > 0) {
            Block = Block->GetBlock(u"QTextColor"_wref.get());
            if (Block->CountParams(pas::concat_wide({u"Sel", EC_Str::IntToWideString(StyleIndex + 1)})) > 0) {
                return pas::concat_wide({u"<color=", Block->GetParam(pas::concat_wide({u"Sel", EC_Str::IntToWideString(StyleIndex + 1)})), u">"});
            }
        }
        if (StyleIndex == 0) {
    ...
    std::uint32_t TfPlanetQuest::GetTextColor(std::int32_t StyleIndex) {
        ...
        if (Block->CountBlocks(u"QTextColor"_wref.get()) > 0) {
            ...
            if (Block->CountParams(pas::concat_wide({u"Text", EC_Str::IntToWideString(StyleIndex + 1)})) > 0) {
                S = Block->GetParam(pas::concat_wide({u"Text", EC_Str::IntToWideString(StyleIndex + 1)}));
                std::int32_t extractDigitsToIntW = EC_Str::ExtractDigitsToIntW(EC_Str::ExtractDelimitedPartW(S, 2, u","_wref.get()));
                std::int32_t extractDigitsToIntW_2 = EC_Str::ExtractDigitsToIntW(EC_Str::ExtractDelimitedPartW(S, 1, u","_wref.get()));
                std::int32_t extractDigitsToIntW_3 = EC_Str::ExtractDigitsToIntW(EC_Str::ExtractDelimitedPartW(S, 0, u","_wref.get()));
    ...
    std::uint32_t TfPlanetQuest::GetDisabledTextColor(std::int32_t StyleIndex) {
        ...
        if (Block->CountBlocks(u"QTextColor"_wref.get()) > 0) {
            ...
            if (Block->CountParams(pas::concat_wide({u"Grey", EC_Str::IntToWideString(StyleIndex + 1)})) > 0) {
                S = Block->GetParam(pas::concat_wide({u"Grey", EC_Str::IntToWideString(StyleIndex + 1)}));
                std::int32_t extractDigitsToIntW = EC_Str::ExtractDigitsToIntW(EC_Str::ExtractDelimitedPartW(S, 2, u","_wref.get()));
                std::int32_t extractDigitsToIntW_2 = EC_Str::ExtractDigitsToIntW(EC_Str::ExtractDelimitedPartW(S, 1, u","_wref.get()));
                std::int32_t extractDigitsToIntW_3 = EC_Str::ExtractDigitsToIntW(EC_Str::ExtractDelimitedPartW(S, 0, u","_wref.get()));
                return GR_Main::CurrentPixelFormat->PackRgb(extractDigitsToIntW_3, extractDigitsToIntW_2, extractDigitsToIntW);
    ...
    void TfPlanetQuest::ApplyStyle() {
        std::int32_t I{};
        pas::WideString Path{};
        pas::checked_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(u"AnimTextOn"_wref.get()))->SetActive(GlobalsV::QuestPageAnimationEnabled);
        pas::checked_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(u"AnimTextOff"_wref.get()))->SetActive(static_cast<std::uint8_t>(GlobalsV::QuestPageAnimationEnabled ^ 1));
        for (auto cpp_range = pas::for_to<std::int32_t>(1, QuestStyleCount); cpp_range.next(I); ) {
            pas::checked_cast<GI_GraphButton::TGraphButtonGI*>(GetByName(static_cast<pas::WideString>(pas::concat_ansi({"Style", SysUtils::IntToStr(I)}))))->SetDisabled(GlobalsV::QuestStyleIndex == I - 1);
        }
        {
            ...
            GI_Image::TImageGI* cpp_arg_2 = pas::checked_cast<GI_Image::TImageGI*>(GetByName(u"BGStyle"_wref.get()));
        ...
        }
        {
            ...
            GI_ScrollBar::TScrollBarGI* verticalScrollBar = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"MessageWindow"_wref.get()))->VerticalScrollBar;
        ...
        }
        {
            ...
            GI_ScrollBar::TScrollBarGI* verticalScrollBar_2 = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()))->VerticalScrollBar;
            verticalScrollBar_2->SetConfigPath(cpp_arg_4);
        }
        GI_MessageLoop::TObjectGI* Control = GetByName(u"MessageWindow"_wref.get())->FirstChild;
        while (Control != nullptr) {
            if (pas::class_cast_if<GI_Label::TLabelGI*>(Control) != nullptr) {
                GI_Label::TLabelGI* cpp_with = pas::checked_cast<GI_Label::TLabelGI*>(Control);
                {
                ...
                }
                {
                    const pas::WideString& replaceAllWideString = ([&] {
                        ...
                        return EC_Str::ReplaceAllWideString(text, textColorTag_2, textColorTag);
                    }());
        ...
        Control = GetByName(u"ActionListWindow"_wref.get())->FirstChild;
        while (Control != nullptr) {
                ...
                }
                {
                    ...
                    }
                    {
                        const pas::WideString& replaceAllWideString_2 = ([&] {
                            ...
                            return EC_Str::ReplaceAllWideString(text_2, textColorTag_4, textColorTag_3);
                        }());
    ...
    void TfPlanetQuest::SelectPageMode(GI_MessageLoop::TObjectGI* Sender) {
        ...
        if (static_cast<std::uint8_t>(Sender->UserValue) != GlobalsV::QuestPageAnimationEnabled) {
            ...
            if (GlobalsV::QuestPageAnimationEnabled) {
                ShowControlHelp(GetByName(u"AnimTextOn"_wref.get()), true);
            } else {
                ShowControlHelp(GetByName(u"AnimTextOff"_wref.get()), true);
            }
            ApplyStyle();
        }
    }
    ...
    void TfPlanetQuest::ShowControlHelp(GI_MessageLoop::TObjectGI* Sender, std::uint8_t Visible) {
        GI_Label::TLabelGI* TextLabel = pas::checked_cast<GI_Label::TLabelGI*>(GetByName(u"LabelHelp"_wref.get()));
    ...
    void TfPlanetQuest::SetQuestPicture(pas::WideString Name) {
        ...
        if (CurrentPicture != Name) {
            CurrentPicture = Name;
            Image = pas::checked_cast<GI_GraphBuf::TGraphBufGI*>(GetByName(u"PQI"_wref.get()));
    ...
    void TfPlanetQuest::QuestKeyDown(GI_MessageLoop::TObjectGI* Sender, std::uint32_t VirtualKey) {
        ...
        if (static_cast<std::uint8_t>(GR_Main::IsVirtualKeyDown(WindowsSdk::VK_CONTROL) ^ 1) && static_cast<std::uint8_t>(GR_Main::IsVirtualKeyDown(WindowsSdk::VK_SHIFT) ^ 1) && static_cast<std::uint8_t>(GR_Main::IsVirtualKeyDown(WindowsSdk::VK_MENU) ^ 1)) {
            ...
            if (VirtualKey >= '1' && VirtualKey <= '9') {
                Index = VirtualKey - '1';
                Panel = pas::checked_cast<GI_PanelScrollBar::TPanelScrollBarGI*>(GetByName(u"ActionListWindow"_wref.get()));
                Control = Panel->FirstChild;
    ...
    pas::WideString TfPlanetQuest::ExpandTemplateText(pas::WideString Text) {
        ...
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(trimWideString), std::move(textColorTag));
            }());
            const pas::WideString& expanded = Expanded;
            return EC_Str::ReplaceAllWideString(expanded, u"<ToStar>"_wref.get(), wrapTextInColor);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_2 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(trimWideString_2), std::move(textColorTag_2));
            }());
            const pas::WideString& expanded_2 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_2, u"<ToPlanet>"_wref.get(), wrapTextInColor_2);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_3 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(text), std::move(textColorTag_3));
            }());
            const pas::WideString& expanded_3 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_3, u"<Date>"_wref.get(), wrapTextInColor_3);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_4 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(text_2), std::move(textColorTag_4));
            }());
            const pas::WideString& expanded_4 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_4, u"<Money>"_wref.get(), wrapTextInColor_4);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_5 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(trimWideString_3), std::move(textColorTag_5));
            }());
            const pas::WideString& expanded_5 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_5, u"<FromPlanet>"_wref.get(), wrapTextInColor_5);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_6 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(trimWideString_4), std::move(textColorTag_6));
            }());
            const pas::WideString& expanded_6 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_6, u"<FromStar>"_wref.get(), wrapTextInColor_6);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_7 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(trimWideString_5), std::move(textColorTag_7));
            }());
            const pas::WideString& expanded_7 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_7, u"<Ranger>"_wref.get(), wrapTextInColor_7);
        }());
        Expanded = ([&] {
            const pas::WideString& wrapTextInColor_8 = ([&] {
                ...
                return aMyFunction::WrapTextInColor(std::move(currentDate), std::move(textColorTag_8));
            }());
            const pas::WideString& expanded_8 = Expanded;
            return EC_Str::ReplaceAllWideString(expanded_8, u"<CurDate>"_wref.get(), wrapTextInColor_8);
        }());
        Expanded = EC_Str::ReplaceAllWideString(Expanded, SourceLineBreak, ReplacementLineBreak);
        Expanded = EC_Str::ReplaceAllWideString(Expanded, IndentedLineBreak, ReplacementLineBreak);
            ...
            if (aPlayer::GetPlayer() != nullptr) {
                Result = ([&] {
                    const pas::WideString& wrapTextInColor_9 = ([&] {
                        ...
                        return aMyFunction::WrapTextInColor(std::move(name), std::move(textColorTag_9));
                    }());
                    const pas::WideString& result = Result;
                    return EC_Str::ReplaceAllWideString(result, u"<Player>"_wref.get(), wrapTextInColor_9);
                }());
            }
            Expanded = ([&] {
                const pas::WideString& textColorTag_10 = GetTextColorTag(GlobalsV::QuestStyleIndex);
                const pas::WideString& expanded_9 = Expanded;
                return EC_Str::ReplaceAllWideString(expanded_9, u"<clr>"_wref.get(), textColorTag_10);
            }());
            Expanded = EC_Str::ReplaceAllWideString(Expanded, u"<clrEnd>"_wref.get(), u"</color>"_wref.get());
        }
        return Expanded;
    }
                    ...
                    if (pas::list_count(aPlayer::GetPlayer()->Quests) > 0) {
                        for (auto cpp_range = pas::for_to<std::int32_t>(0, pas::list_count(aPlayer::GetPlayer()->Quests) - 1); cpp_range.next(I); ) {
                            ...
                            if (GovernmentQuest->QuestType == aGalaxyStruct::qtPlanetQuest && pas::class_cast_if<aPlanet::TPlanet*>(GovernmentQuest->ObjectiveTarget) != nullptr && aPlayer::GetPlayer()->CurrentPlanet == pas::checked_cast<aPlanet::TPlanet*>(GovernmentQuest->ObjectiveTarget)) {
                                ...
                                pas::checked_cast<GI_Panel::TPanelGI*>(GetByName(u"QuestPanel"_wref.get()))->SetActive(false);
                                if (aPlayer::GetPlayer()->CurrentPlanet->IsCoalitionOwned || aPlayer::GetPlayer()->CurrentPlanet->OwnerId == static_cast<std::uint8_t>(aGalaxyStruct::oiPirate)) {
    ...
    void TfPlanetQuest::CompleteQuestFailure(std::int32_t Value) {
        ...
        if (aPlayer::GetPlayer() == nullptr) {
            ...
            if (aPlayer::GetPlayer()->CurrentPlanet != nullptr) {
                if (aPlayer::GetPlayer()->CurrentPlanet->OwnerId == static_cast<std::uint8_t>(aGalaxyStruct::oiPirate) && aPlanet::MainPiratePlanet != nullptr) {
    ...
    void TfPlanetQuest::ApplyLegacyPictureOverrides() {
        ...
        EC_BlockPar::TBlockParEC* Config = GR_Main::GameDataConfig->GetBlock(u"PQI"_wref.get());
        ...
        for (auto cpp_range = pas::for_to<std::int32_t>(0, Count - 1); cpp_range.next(I); ) {
            ...
            if (TfPlanetQuest::GetTextBeforeDelimiter(Name, u',') == QuestName) {
                Kind = TfPlanetQuest::GetTextAfterComma(Name, u',');
                Indices = TfPlanetQuest::GetTextAfterComma(Kind, u',');
                Kind = TfPlanetQuest::GetTextBeforeDelimiter(Kind, u',');
                Values->LoadFromSemicolonText(Indices);
                Picture = Config->GetParamValue(I);
                Picture = EC_Str::ReplaceAllWideString(Picture, u"Bm.PQI."_wref.get(), u""_wref.get());
                if (Kind == u"L") {
            ...
            if (EC_Str::FindTextPosW(u"ext_"_wref.get(), Quest->GetParameter(I + 0)->NameText->Text) == 1) {
                ...
                if (Variable != nullptr) {
                    Expanded = ([&] {
                        ...
                        const pas::WideString& expanded = Expanded;
                        return EC_Str::ReplaceAllWideString(expanded, token, wrapTextInColor);
                    }());
                }
            }
        }
