...
namespace PopUp {
    ...
    GI_MessageLoop::TObjectGI* TfPopUpController::CreatePopup(pas::WideString Text, pas::WideString ImagePath) {
        GI_Panel::TPanelGI* Panel = pas::construct_call<GI_Panel::TPanelGI>(GI_Panel::TPanelGI_Create, this);
